    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-zinc-600 mt-0.5">Refreshed {ts.toLocaleTimeString()}</p>
        </div>
        <button
          onClick={refresh}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg">
          <div className="flex items-center justify-between px-5 py-3 border-b border-zinc-800">
            ...
            <Link to="/inventory" className="text-xs font-mono text-[#b5f23d] flex items-center gap-1">
          ...
          {critical.length === 0 && !loading && (
            <div className="py-10 text-center text-zinc-600 font-mono text-sm">No critical SKUs</div>
          )}
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg">
          <div className="flex items-center justify-between px-5 py-3 border-b border-zinc-800">
            ...
            <Link to="/analysis" className="text-xs font-mono text-[#b5f23d] flex items-center gap-1">
          ...
          {runs.length === 0 && (
            <div className="py-10 text-center text-zinc-600 font-mono text-sm">No runs yet</div>
          )}
        </div>
      </div>
    </div>
