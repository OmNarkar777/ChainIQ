...
function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center py-32 text-center">
      ...
      <p className="text-zinc-400 font-mono text-sm mb-6">Page not found</p>
      <Link
        to="/"
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-zinc-800 bg-zinc-950/80 backdrop-blur sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-6">
          <Link to="/" className="flex items-center gap-2.5 shrink-0 group">
            <div className="w-6 h-6 bg-[#b5f23d] rounded flex items-center justify-center group-hover:opacity-90 transition-opacity">
            ...
            <span className="font-mono text-xs text-zinc-700 hidden sm:block">
      ...
      <footer className="border-t border-zinc-900 py-3 px-4">
        <p className="text-center text-xs font-mono text-zinc-800">
          ChainIQ · XGBoost + LangGraph + ChromaDB + Groq
        </p>
      </footer>
    </div>
  );
